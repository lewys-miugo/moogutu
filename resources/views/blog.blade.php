        ...
        <div class="lg:m-8 flex flex-row flex-wrap">            
            <div class="my-4 p-4 w-1/3 max-h-80">
                <a class="flex items-center flex-col">
                    ...
                    <div>
                        <h2 class="px-2 text-bluetange text-sitange" >Chandarana Foodplus Marketing Goof: a Lesson from Condoleezza Rice on Political Risk Through Social Activism</h2>
                        <p class="text-sm pl-2 text-left">Read More</p>
